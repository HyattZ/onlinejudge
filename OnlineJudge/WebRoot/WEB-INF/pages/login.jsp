...
<script type="text/javascript" language="javascript">
	function getAuthCodeAgain(){
		$("#authCodeImg").attr("src","http://localhost:8080/OnlineJudge/getAuthCode?zxt="+Math.random());
		}
</script>
</head>
  ...
  <form class="form-horizontal" action="login" method="post">
    <div class="modal" id="login"  style="margin-top:50px;">
      ...
      <div class="modal-body">
          ...
          <div class="control-group">
            <div class="controls">
              <input type="text" id="authCode" placeholder="验证码" name="authCode" style="width:100px;">
              <img src="http://localhost:8080/OnlineJudge/getAuthCode" class="authCodeStyle" id="authCodeImg">
              <a href="javascript:void(0)" onClick="getAuthCodeAgain()">看不清</a>
             </div>
          </div>
      </div>
